...
@cli.command()
@click.option("--count", default=100, help="Number of bookmarks to fetch")
@click.option("--db-path", type=click.Path(), help="Path to database file")
...
@click.option("--threshold", default=0.8, help="Similarity threshold for semantic search")
...
@click.option("--max-tags", default=8, help="Maximum number of tags to generate")
...
@cli.command()
@click.option("--limit", default=50, help="Maximum number of tags to display")
@click.option("--source", help="Filter by source (user, master, system)")
@click.option("--db-path", type=click.Path(), help="Path to database file")
